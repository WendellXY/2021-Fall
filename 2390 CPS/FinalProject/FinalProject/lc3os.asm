...
;;;   r2 - color
;;; Output
;;;   video memory will be updated to place 6x6 block of approriate color
...
DRAW_BLOCK:
	...
	ADD R5,R5,#4		;set it to the value 4.
DRAW_LOOP_START:
	STR R2, R3,#0
	STR R2, R3,#1
	STR R2, R3,#2
...
BREAK:
        ...
        RTT
PIXEL_PER_INCR:     .FILL 0x4
VIDEO_START_OFF:    .FILL 528
VIDEO:              .FILL xC000
